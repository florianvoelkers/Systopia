...
public class ConditionCollectionEditor : EditorWithSubEditors <ConditionEditor, Condition> {
	...
	private SerializedProperty descriptionsProperty;
	...
	private const string conditionCollectPropRequiredConditionsName = "requiredConditions";
	...
	private void OnEnable () {
		...
		descriptionsProperty = serializedObject.FindProperty (conditionCollectionPropDescriptionName);
		conditionsProperty = serializedObject.FindProperty (conditionCollectPropRequiredConditionsName);
	...
	public override void OnInspectorGUI () {
		...
		descriptionsProperty.isExpanded = EditorGUILayout.Foldout (descriptionsProperty.isExpanded, descriptionsProperty.stringValue);
		...
		if (descriptionsProperty.isExpanded) {
			ExpandedGUI ();
		}
	...
	private void ExpandedGUI () {
		...
		EditorGUILayout.PropertyField (descriptionsProperty);
		EditorGUILayout.Space ();
